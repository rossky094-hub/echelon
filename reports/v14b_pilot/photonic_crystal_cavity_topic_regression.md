...
| turning papers with decision-grade section evidence | 1 | 2 | fail |
...
- Key turning papers: 9 total, 9 with access links, 3 with primary local sections, 3 with strong/moderate parser provenance, 1 with decision-grade current-contract evidence.
