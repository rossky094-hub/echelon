...
- generated_at: `2026-05-30T22:16:33Z`
...
- current parser-contract primary section papers: 139
...
| success_primary | 1,832 |
| already_has_primary | 443 |
...
| event | count |
| --- | ---: |
| pdf_graphics_warning | 55,721 |
| download_failure | 22,646 |
| parser_exception | 3 |
| timeout | 1 |

- section progress: 165/8592 (logs/v14b/step5s_section_delta.log)
...
- progress: `165/8592`
- rows / papers / primary papers: `5,340` / `3,020` / `3,020`
