...
- section evidence: 5,602 rows / 3,029 papers
- primary section evidence: 3,029 papers (5.5%)
- primary section provenance: 1,306 strong/moderate papers; weak-only=56.9%
- current section parser contract: 582 papers (19.2%)
- section parser contracts: legacy_unknown_contract:4,285, v14b_section_parser_contract_v3_toc_guard:1,317
...
- section frontfill health: running_or_unknown [section_delta] (done=380/8373, no_evidence_delta=0, no_evidence_hours=0.0, current_contract_primary=578, contract_status=running_or_unknown, no_current_contract_delta=0, no_current_contract_hours=0.0)
...
- **section_evidence_provenance** (medium): primary section evidence quality is still fragile: 1,306 papers have strong/moderate parser provenance; weak-only rate is 56.9%. Next: Use explicit/embedded heading evidence for bottleneck and Claim Card promotion; keep loose/legacy section matches as weak evidence until manually audited or re-parsed.
- **section_parser_contract_coverage** (medium): primary section evidence has current parser-contract coverage for only 582/3,029 papers (19.2%); legacy parser-contract sections may predate TOC/fragment guards. Next: Re-run section evidence with the current parser contract before promoting section-derived bottleneck, Topic Dossier, or Claim Card claims.
