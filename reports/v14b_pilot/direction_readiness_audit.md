...
- generated_at: `2026-05-30T18:44:56Z`
...
- section evidence: 4,968 rows / 2,826 papers
- primary section evidence: 2,826 papers (5.1%)
- primary section provenance: 589 strong/moderate papers; weak-only=79.2%
...
- **section_evidence** (high): primary section evidence covers only 2,826 papers. Next: Finish top12000 section ingest, then run delta section queue for main/future/branch/keystone papers.
- **section_evidence_provenance** (medium): primary section evidence quality is still fragile: 589 papers have strong/moderate parser provenance; weak-only rate is 79.2%. Next: Use explicit/embedded heading evidence for bottleneck and Claim Card promotion; keep loose/legacy section matches as weak evidence until manually audited or re-parsed.
