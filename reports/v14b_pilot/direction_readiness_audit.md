...
- generated_at: `2026-05-29T17:30:51Z`
- readiness_level: `candidate_generator_only`

## Metrics

- linked refs: 443,077 / 3,200,038 (13.8%)
- OpenAlex W IDs: 34,478 (62.2%)
- section evidence: 1,284 rows / 714 papers
- primary section evidence: 714 papers (1.3%)
...
- **section_evidence** (high): primary section evidence covers only 714 papers. Next: Finish top12000 section ingest, then run delta section queue for main/future/branch/keystone papers.
