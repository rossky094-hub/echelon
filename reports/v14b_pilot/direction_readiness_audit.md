...
- generated_at: `2026-05-30T15:25:11Z`
...
- section evidence: 4,566 rows / 2,615 papers
- primary section evidence: 2,615 papers (4.7%)
- primary section provenance: 378 strong/moderate papers; weak-only=85.5%
- multi-topic evidence-gap queue: 0 / 20 primary-section covered (0.0%)
- section frontfill health: running_or_unknown [section_delta] (done=423/6603, no_evidence_delta=0, no_evidence_hours=0.0)
...
- **section_evidence** (high): primary section evidence covers only 2,615 papers. Next: Finish top12000 section ingest, then run delta section queue for main/future/branch/keystone papers.
- **section_evidence_provenance** (medium): primary section evidence quality is still fragile: 378 papers have strong/moderate parser provenance; weak-only rate is 85.5%. Next: Use explicit/embedded heading evidence for bottleneck and Claim Card promotion; keep loose/legacy section matches as weak evidence until manually audited or re-parsed.
