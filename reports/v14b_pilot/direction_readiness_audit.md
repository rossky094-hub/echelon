...
- generated_at: `2026-05-31T02:25:48Z`
...
- section evidence: 5,483 rows / 3,021 papers
- primary section evidence: 3,021 papers (5.5%)
- primary section provenance: 1,130 strong/moderate papers; weak-only=62.6%
- current section parser contract: 374 papers (12.4%)
- section parser contracts: legacy_unknown_contract:4,630, v14b_section_parser_contract_v3_toc_guard:853
...
- section frontfill health: running_or_unknown [section_delta] (done=400/8592, no_evidence_delta=0, no_evidence_hours=0.0, current_contract_primary=368, contract_status=running_or_unknown, no_current_contract_delta=0, no_current_contract_hours=0.0)
