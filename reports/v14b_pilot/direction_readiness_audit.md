...
- section evidence: 5,464 rows / 3,021 papers
- primary section evidence: 3,021 papers (5.5%)
- primary section provenance: 1,099 strong/moderate papers; weak-only=63.6%
- current section parser contract: 343 papers (11.4%)
- section parser contracts: legacy_unknown_contract:4,676, v14b_section_parser_contract_v3_toc_guard:788
...
- section frontfill health: running_or_unknown [section_delta] (done=369/8592, no_evidence_delta=0, no_evidence_hours=0.0, current_contract_primary=339, contract_status=running_or_unknown, no_current_contract_delta=0, no_current_contract_hours=0.0)
