...
- generated_at: `2026-05-30T16:14:03Z`
...
- section evidence: 4,585 rows / 2,626 papers
- primary section evidence: 2,626 papers (4.7%)
- primary section provenance: 389 strong/moderate papers; weak-only=85.2%
...
- **section_evidence** (high): primary section evidence covers only 2,626 papers. Next: Finish top12000 section ingest, then run delta section queue for main/future/branch/keystone papers.
- **section_evidence_provenance** (medium): primary section evidence quality is still fragile: 389 papers have strong/moderate parser provenance; weak-only rate is 85.2%. Next: Use explicit/embedded heading evidence for bottleneck and Claim Card promotion; keep loose/legacy section matches as weak evidence until manually audited or re-parsed.
