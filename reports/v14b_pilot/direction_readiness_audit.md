...
- generated_at: `2026-05-30T21:00:05Z`
...
- OpenAlex frontfill health: cooling_down_or_stopped [openalex_backfill_current] (processed=3000/22643, ok=2898, fail=102, cooldown_hours=3.0)
- section evidence: 5,231 rows / 2,984 papers
- primary section evidence: 2,984 papers (5.4%)
- primary section provenance: 747 strong/moderate papers; weak-only=75.0%
- multi-topic evidence-gap queue: 0 / 41 primary-section covered (0.0%)
- section frontfill health: running_or_unknown [section_delta] (done=964/6603, no_evidence_delta=0, no_evidence_hours=0.0)
...
- **section_evidence** (high): primary section evidence covers only 2,984 papers. Next: Finish top12000 section ingest, then run delta section queue for main/future/branch/keystone papers.
- **section_evidence_provenance** (medium): primary section evidence quality is still fragile: 747 papers have strong/moderate parser provenance; weak-only rate is 75.0%. Next: Use explicit/embedded heading evidence for bottleneck and Claim Card promotion; keep loose/legacy section matches as weak evidence until manually audited or re-parsed.
...
- **openalex_frontfill_health** (medium): OpenAlex frontfill is cooling_down_or_stopped; processed=3000/22643, cooldown_remaining_hours=3.0. Next: Respect the OpenAlex 429 cooldown; resume conservative backfill after cooldown before promoting cross-field/topic claims.
