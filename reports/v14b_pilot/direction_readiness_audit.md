...
- generated_at: `2026-05-31T11:51:34Z`
...
- section evidence: 5,678 rows / 3,030 papers
- primary section evidence: 3,030 papers (5.5%)
- primary section provenance: 1,424 strong/moderate papers; weak-only=53.0%
- current section parser contract: 708 papers (23.4%)
- section parser contracts: legacy_unknown_contract:4,078, v14b_section_parser_contract_v3_toc_guard:1,600
...
- section frontfill health: running_or_unknown [section_delta] (done=508/8373, no_evidence_delta=0, no_evidence_hours=0.0, current_contract_primary=705, contract_status=running_or_unknown, no_current_contract_delta=0, no_current_contract_hours=0.0)
- raw PDF store: `pass`; success=5,013; probable_pdf_rate=100.0%; section_cache_papers=6; topic_gap_local_pdf=15/78
...
- **section_evidence_provenance** (medium): primary section evidence quality is still fragile: 1,424 papers have strong/moderate parser provenance; weak-only rate is 53.0%. Next: Use explicit/embedded heading evidence for bottleneck and Claim Card promotion; keep loose/legacy section matches as weak evidence until manually audited or re-parsed.
- **section_parser_contract_coverage** (medium): primary section evidence has current parser-contract coverage for only 708/3,030 papers (23.4%); legacy parser-contract sections may predate TOC/fragment guards. Next: Re-run section evidence with the current parser contract before promoting section-derived bottleneck, Topic Dossier, or Claim Card claims.
