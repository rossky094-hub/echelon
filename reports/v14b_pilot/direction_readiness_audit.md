...
- generated_at: `2026-05-30T15:31:12Z`
...
- section evidence: 4,571 rows / 2,617 papers
- primary section evidence: 2,617 papers (4.7%)
- primary section provenance: 380 strong/moderate papers; weak-only=85.5%
...
- **section_evidence** (high): primary section evidence covers only 2,617 papers. Next: Finish top12000 section ingest, then run delta section queue for main/future/branch/keystone papers.
- **section_evidence_provenance** (medium): primary section evidence quality is still fragile: 380 papers have strong/moderate parser provenance; weak-only rate is 85.5%. Next: Use explicit/embedded heading evidence for bottleneck and Claim Card promotion; keep loose/legacy section matches as weak evidence until manually audited or re-parsed.
