...
- generated_at: `2026-05-30T18:25:33Z`
...
- OpenAlex frontfill health: cooling_down_or_stopped [openalex_backfill_current] (processed=3000/22643, ok=2898, fail=102, cooldown_hours=5.6)
- section evidence: 4,848 rows / 2,767 papers
- primary section evidence: 2,767 papers (5.0%)
- primary section provenance: 530 strong/moderate papers; weak-only=80.8%
- multi-topic evidence-gap queue: 0 / 20 primary-section covered (0.0%)
- section frontfill health: running_or_unknown [section_delta] (done=589/6603, no_evidence_delta=0, no_evidence_hours=0.0)
...
- **section_evidence** (high): primary section evidence covers only 2,767 papers. Next: Finish top12000 section ingest, then run delta section queue for main/future/branch/keystone papers.
- **section_evidence_provenance** (medium): primary section evidence quality is still fragile: 530 papers have strong/moderate parser provenance; weak-only rate is 80.8%. Next: Use explicit/embedded heading evidence for bottleneck and Claim Card promotion; keep loose/legacy section matches as weak evidence until manually audited or re-parsed.
...
- **openalex_frontfill_health** (medium): OpenAlex frontfill is cooling_down_or_stopped; processed=3000/22643, cooldown_remaining_hours=5.6. Next: Respect the OpenAlex 429 cooldown; resume conservative backfill after cooldown before promoting cross-field/topic claims.
