...
- generated_at: `2026-05-29T17:40:24Z`
- readiness_level: `candidate_generator_only`

## Metrics

- linked refs: 443,077 / 3,200,540 (13.8%)
- OpenAlex W IDs: 34,515 (62.3%)
- section evidence: 1,302 rows / 721 papers
- primary section evidence: 721 papers (1.3%)
...
- **section_evidence** (high): primary section evidence covers only 721 papers. Next: Finish top12000 section ingest, then run delta section queue for main/future/branch/keystone papers.
