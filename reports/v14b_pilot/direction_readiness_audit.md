...
- **openalex_topic_coverage** (medium): OpenAlex W coverage is 61.1%; cross-field claims need uncertainty. Next: Keep conservative OpenAlex backfill; use local field/topic fallback while labeling uncertainty.
