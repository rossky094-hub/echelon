...
- generated_at: `2026-05-30T15:00:25Z`
...
- section evidence: 4,536 rows / 2,600 papers
- primary section evidence: 2,600 papers (4.7%)
- primary section provenance: 363 strong/moderate papers; weak-only=86.0%
...
- **section_evidence** (high): primary section evidence covers only 2,600 papers. Next: Finish top12000 section ingest, then run delta section queue for main/future/branch/keystone papers.
- **section_evidence_provenance** (medium): primary section evidence quality is still fragile: 363 papers have strong/moderate parser provenance; weak-only rate is 86.0%. Next: Use explicit/embedded heading evidence for bottleneck and Claim Card promotion; keep loose/legacy section matches as weak evidence until manually audited or re-parsed.
