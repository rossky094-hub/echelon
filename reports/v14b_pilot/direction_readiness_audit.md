...
- generated_at: `2026-05-30T14:43:15Z`
...
- section evidence: 4,529 rows / 2,595 papers
- primary section evidence: 2,595 papers (4.7%)
- primary section provenance: 358 strong/moderate papers; weak-only=86.2%
- multi-topic evidence-gap queue: 0 / 20 primary-section covered (0.0%)
- section frontfill health: running_or_unknown [section_delta] (done=411/6603, no_evidence_delta=0, no_evidence_hours=0.0)
...
- **section_evidence** (high): primary section evidence covers only 2,595 papers. Next: Finish top12000 section ingest, then run delta section queue for main/future/branch/keystone papers.
- **section_evidence_provenance** (medium): primary section evidence quality is still fragile: 358 papers have strong/moderate parser provenance; weak-only rate is 86.2%. Next: Use explicit/embedded heading evidence for bottleneck and Claim Card promotion; keep loose/legacy section matches as weak evidence until manually audited or re-parsed.
