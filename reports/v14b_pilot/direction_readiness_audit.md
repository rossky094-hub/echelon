...
- generated_at: `2026-05-30T14:25:28Z`
...
- section evidence: 4,517 rows / 2,591 papers
- primary section evidence: 2,591 papers (4.7%)
- primary section provenance: 354 strong/moderate papers; weak-only=86.3%
...
- **section_evidence** (high): primary section evidence covers only 2,591 papers. Next: Finish top12000 section ingest, then run delta section queue for main/future/branch/keystone papers.
- **section_evidence_provenance** (medium): primary section evidence quality is still fragile: 354 papers have strong/moderate parser provenance; weak-only rate is 86.3%. Next: Use explicit/embedded heading evidence for bottleneck and Claim Card promotion; keep loose/legacy section matches as weak evidence until manually audited or re-parsed.
