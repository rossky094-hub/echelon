...
- generated_at: `2026-05-30T14:35:45Z`
...
- section evidence: 4,526 rows / 2,594 papers
- primary section evidence: 2,594 papers (4.7%)
- primary section provenance: 357 strong/moderate papers; weak-only=86.2%
...
- **section_evidence** (high): primary section evidence covers only 2,594 papers. Next: Finish top12000 section ingest, then run delta section queue for main/future/branch/keystone papers.
- **section_evidence_provenance** (medium): primary section evidence quality is still fragile: 357 papers have strong/moderate parser provenance; weak-only rate is 86.2%. Next: Use explicit/embedded heading evidence for bottleneck and Claim Card promotion; keep loose/legacy section matches as weak evidence until manually audited or re-parsed.
