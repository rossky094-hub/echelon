...
- generated_at: `2026-05-30T22:46:42Z`
...
- OpenAlex frontfill health: cooling_down_or_stopped [openalex_backfill_current] (processed=3000/22643, ok=2898, fail=102, cooldown_hours=1.2)
- section evidence: 5,345 rows / 3,020 papers
- primary section evidence: 3,020 papers (5.5%)
- primary section provenance: 911 strong/moderate papers; weak-only=69.8%
- current section parser contract: 154 papers (5.1%)
- section parser contracts: legacy_unknown_contract:5,031, v14b_section_parser_contract_v3_toc_guard:314
...
- **openalex_frontfill_health** (medium): OpenAlex frontfill is cooling_down_or_stopped; processed=3000/22643, cooldown_remaining_hours=1.2. Next: Respect the OpenAlex 429 cooldown; resume conservative backfill after cooldown before promoting cross-field/topic claims.

## Latest Fusion Audit

```json
{
  "run_id": "20260530T224601Z",
  ...
  "created_at": "2026-05-30 22:46:01",
