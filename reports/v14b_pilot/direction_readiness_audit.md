...
- generated_at: `2026-05-31T11:12:42Z`
...
- section evidence: 5,667 rows / 3,030 papers
- primary section evidence: 3,030 papers (5.5%)
- primary section provenance: 1,407 strong/moderate papers; weak-only=53.6%
- current section parser contract: 690 papers (22.8%)
- section parser contracts: legacy_unknown_contract:4,107, v14b_section_parser_contract_v3_toc_guard:1,560
...
- section frontfill health: running_or_unknown [section_delta] (done=490/8373, no_evidence_delta=0, no_evidence_hours=0.0, current_contract_primary=685, contract_status=running_or_unknown, no_current_contract_delta=0, no_current_contract_hours=0.0)
