...
- generated_at: `2026-05-31T10:25:38Z`
...
- section evidence: 5,627 rows / 3,030 papers
- primary section evidence: 3,030 papers (5.5%)
- primary section provenance: 1,363 strong/moderate papers; weak-only=55.0%
- current section parser contract: 643 papers (21.2%)
- section parser contracts: legacy_unknown_contract:4,183, v14b_section_parser_contract_v3_toc_guard:1,444
- multi-topic evidence-gap queue: 43 / 78 decision-grade section covered (55.1%); raw primary=48 (61.5%)
- topic-gap section triage: `fail`; current-parser no-target=17; stale-contract=4; unattempted-PDF=8; missing-stages=constraint:1,attempted_path:1,local_fix:1; repair-contract-closed=17/215
...
- section frontfill health: running_or_unknown [section_delta] (done=443/8373, no_evidence_delta=0, no_evidence_hours=0.0, current_contract_primary=640, contract_status=running_or_unknown, no_current_contract_delta=0, no_current_contract_hours=0.0)
...
- **section_evidence_provenance** (medium): primary section evidence quality is still fragile: 1,363 papers have strong/moderate parser provenance; weak-only rate is 55.0%. Next: Use explicit/embedded heading evidence for bottleneck and Claim Card promotion; keep loose/legacy section matches as weak evidence until manually audited or re-parsed.
- **section_parser_contract_coverage** (medium): primary section evidence has current parser-contract coverage for only 643/3,030 papers (21.2%); legacy parser-contract sections may predate TOC/fragment guards. Next: Re-run section evidence with the current parser contract before promoting section-derived bottleneck, Topic Dossier, or Claim Card claims.
