...
- primary section provenance: 1,229 strong/moderate papers; weak-only=59.4%
- current section parser contract: 486 papers (16.0%)
- section parser contracts: legacy_unknown_contract:4,440, v14b_section_parser_contract_v3_toc_guard:1,115
...
- section frontfill health: running_or_unknown [section_delta] (done=284/8373, no_evidence_delta=0, no_evidence_hours=0.0, current_contract_primary=468, contract_status=running_or_unknown, no_current_contract_delta=0, no_current_contract_hours=0.0)
