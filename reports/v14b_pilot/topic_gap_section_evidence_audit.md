...
| failure_mode | papers |
|---|---:|
| decision_grade_current_contract | 23 |
...
|---|---:|---:|---:|---|
| metalens | 12 | 7 | 58.3% | decision_grade_current_contract:7, no_target_sections_after_current_parser:5 |
| metasurface holography | 12 | 8 | 66.7% | decision_grade_current_contract:8, no_target_sections_after_current_parser:4 |
| photonic crystal cavity | 20 | 11 | 55.0% | decision_grade_current_contract:11, no_target_sections_after_current_parser:9 |
| quantum light source | 22 | 12 | 54.5% | decision_grade_current_contract:12, no_target_sections_after_current_parser:8, unattempted_pdf_available:2 |
...
| 4 | `01KS5KVWY6VAA6HXWFJV2SXZ48` | photonic crystal cavity | `decision_grade_current_contract` | `success_primary` | Hybrid photonic crystal cavity and waveguide for coupling to diamond NV-centers |
...
| 7 | `01KS6FFJF6XNCHFY2X589F6QD5` | photonic crystal cavity | `decision_grade_current_contract` | `success_primary` | Efficient Terahertz Generation in Triply Resonant Nonlinear Photonic Crystal Microcavities |
...
| 10 | `01KS6FK557AWZRGP7QFMMBVT17` | quantum light source | `decision_grade_current_contract` | `success_primary` | Quantum interface between frequency-uncorrelated down-converted entanglement and atomic-ensemble quantum memory |
| 11 | `01KS6GKT1AN2MQ1NXP1ZJY5EKA` | quantum light source | `decision_grade_current_contract` | `success_primary` | Ultra-broadband continuously-tunable polarization entangled photon pair source covering the C+L telecom bands based on a single type-II PPKTP crystal |
...
| 13 | `01KS6H25PCS743PEWJ8HF8YGEH` | quantum light source | `decision_grade_current_contract` | `success_primary` | Tunable narrow band source via the strong coupling between optical emitter and nanowire surface plasmons |
| 14 | `01KS5KJ583SB217NBQYZSWC42R` | metalens | `decision_grade_current_contract` | `success_primary` | Metalens With Artificial Focus Pattern |
...
| 19 | `01KS6GH1AHNF1EQ3V7VRZ28RPP` | metasurface holography | `decision_grade_current_contract` | `success_primary` | Exploring shot noise and Laser Doppler imagery with heterodyne holography |
| 20 | `01KS6HDG6MYN3Y7HPYW7KRRKQJ` | metalens | `decision_grade_current_contract` | `success_primary` | Broadband Multifocal Conic-Shaped Metalens |
...
| 23 | `01KS6HK2C4GYG2KSM1BA314XPY` | metasurface holography | `decision_grade_current_contract` | `success_primary` | Implementation of radiating aperture field distribution using tensorial metasurfaces |
...
| 27 | `01KS6HR11SMNBNHF2EH7HQD1B8` | metasurface holography | `decision_grade_current_contract` | `success_primary` | Designing high-transmission and wide angle all-dielectric flat metasurfaces at telecom wavelengths |
| 28 | `01KS6HX81HS8PYCYKDM0Z285J8` | metasurface holography | `decision_grade_current_contract` | `success_primary` | Direct phase mapping of broadband Laguerre-Gaussian metasurfaces |
| 29 | `01KS6J1DE5H1JYZ15HXF8CC6CF` | metalens | `decision_grade_current_contract` | `success_primary` | Near-IR wide field-of-view Huygens metalens for outdoor imaging applications |
