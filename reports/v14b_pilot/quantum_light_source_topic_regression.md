...
| key_turning_paper_missing_primary_section |  | 95 | 7 | Topic turning papers cannot support lineage or Claim Card interpretation until their local primary sections are parsed. |
| key_turning_paper_weak_section_provenance |  | 95 | 1 | These turning papers have primary sections, but parser provenance is too weak for decision-grade lineage claims. |
...
| branch_lineage_needs_evidence |  | 85 | 3 | Branch splits remain weak/layout candidates until driver papers and section-level constraint shifts are parsed. |
| future_candidates_missing_claim_card |  | 85 | 9 | GNN/VGAE future edges are useful for recall, but they need fusion evidence and complete five-question Claim Cards before decision use. |
