...
- audit_ts: `2026-05-30T13:55:49Z`
- current top_n budget: `12000`
- high-value papers considered: `12,514`
- next delta queue needing primary section/action: `6,229`
...
| retry_class | count |
|---|---:|
| not_attempted_pdf_available | 6,163 |
| no_target_sections | 4,071 |
| covered | 2,234 |
...
| branch_split_driver | 1,970 | 1,970 | 647 | 647 | 1,970 |
