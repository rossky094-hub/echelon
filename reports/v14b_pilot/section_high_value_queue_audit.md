...
- audit_ts: `2026-05-30T17:33:49Z`
- current top_n budget: `12000`
- high-value papers considered: `12,514`
- next delta queue needing primary section/action: `6,076`
...
| retry_class | count |
|---|---:|
| not_attempted_pdf_available | 6,010 |
| no_target_sections | 4,101 |
| covered | 2,357 |
...
| branch_split_driver | 1,970 | 1,970 | 764 | 764 | 1,970 |
