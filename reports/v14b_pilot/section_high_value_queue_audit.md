...
- audit_ts: `2026-05-30T15:00:20Z`
- current top_n budget: `12000`
- high-value papers considered: `12,514`
- next delta queue needing primary section/action: `6,207`
...
| retry_class | count |
|---|---:|
| not_attempted_pdf_available | 6,141 |
| no_target_sections | 4,078 |
| covered | 2,249 |
...
| branch_split_driver | 1,970 | 1,970 | 662 | 662 | 1,970 |
