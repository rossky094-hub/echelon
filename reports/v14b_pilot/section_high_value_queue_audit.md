...
- audit_ts: `2026-05-30T14:35:40Z`
- current top_n budget: `12000`
- high-value papers considered: `12,514`
- next delta queue needing primary section/action: `6,214`
...
| retry_class | count |
|---|---:|
| not_attempted_pdf_available | 6,148 |
| no_target_sections | 4,077 |
| covered | 2,243 |
...
| branch_split_driver | 1,970 | 1,970 | 656 | 656 | 1,970 |
