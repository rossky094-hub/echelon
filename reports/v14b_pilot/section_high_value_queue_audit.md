...
- audit_ts: `2026-05-30T17:21:16Z`
- current top_n budget: `12000`
- high-value papers considered: `12,514`
- next delta queue needing primary section/action: `6,087`
...
| retry_class | count |
|---|---:|
| not_attempted_pdf_available | 6,021 |
| no_target_sections | 4,099 |
| covered | 2,348 |
...
| branch_split_driver | 1,970 | 1,970 | 756 | 756 | 1,970 |
