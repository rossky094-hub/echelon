...
- audit_ts: `2026-05-30T19:00:25Z`
- current top_n budget: `12000`
- high-value papers considered: `12,514`
- next delta queue needing primary section/action: `5,874`
...
| retry_class | count |
|---|---:|
| not_attempted_pdf_available | 5,808 |
...
| branch_split_driver | 1,970 | 1,970 | 915 | 915 | 1,970 |
