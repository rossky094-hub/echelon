...
- audit_ts: `2026-05-30T14:43:09Z`
- current top_n budget: `12000`
- high-value papers considered: `12,514`
- next delta queue needing primary section/action: `6,212`
...
| retry_class | count |
|---|---:|
| not_attempted_pdf_available | 6,146 |
...
| branch_split_driver | 1,970 | 1,970 | 657 | 657 | 1,970 |
