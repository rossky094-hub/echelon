...
- audit_ts: `2026-05-30T16:21:31Z`
- current top_n budget: `12000`
- high-value papers considered: `12,514`
- next delta queue needing primary section/action: `6,172`
...
| retry_class | count |
|---|---:|
| not_attempted_pdf_available | 6,106 |
| no_target_sections | 4,087 |
| covered | 2,275 |
...
| branch_split_driver | 1,970 | 1,970 | 688 | 688 | 1,970 |
