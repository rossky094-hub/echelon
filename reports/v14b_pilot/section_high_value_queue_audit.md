...
- audit_ts: `2026-05-30T05:47:59Z`
- current top_n budget: `12000`
- high-value papers considered: `12,514`
- next delta queue needing primary section/action: `6,603`
- multi-topic evidence-gap rows merged: `23` (39 papers)
...
| retry_class | count |
|---|---:|
| not_attempted_pdf_available | 6,537 |
| no_target_sections | 3,990 |
| covered | 1,941 |
...
| branch_split_driver | 1,970 | 1,970 | 362 | 362 | 1,970 |
| cluster_representative | 5,958 | 5,331 | 697 | 697 | 5,958 |
| future_endpoint | 291 | 291 | 89 | 89 | 291 |
...
| topic:metalens | 257 | 86 | 86 | 86 | 257 |
...
| topic_gap_key_turning_section | 17 | 9 | 0 | 0 | 17 |
