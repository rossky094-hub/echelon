...
- audit_ts: `2026-05-30T17:59:00Z`
- current top_n budget: `12000`
- high-value papers considered: `12,514`
- next delta queue needing primary section/action: `6,043`
...
| retry_class | count |
|---|---:|
| not_attempted_pdf_available | 5,977 |
| no_target_sections | 4,110 |
| covered | 2,381 |
...
| branch_split_driver | 1,970 | 1,970 | 787 | 787 | 1,970 |
| cluster_representative | 5,958 | 5,331 | 698 | 698 | 5,958 |
| future_endpoint | 291 | 291 | 103 | 103 | 291 |
