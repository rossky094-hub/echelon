...
- audit_ts: `2026-05-30T17:28:02Z`
- current top_n budget: `12000`
- high-value papers considered: `12,514`
- next delta queue needing primary section/action: `6,081`
...
| retry_class | count |
|---|---:|
| not_attempted_pdf_available | 6,015 |
| no_target_sections | 4,100 |
| covered | 2,353 |
...
| branch_split_driver | 1,970 | 1,970 | 761 | 761 | 1,970 |
