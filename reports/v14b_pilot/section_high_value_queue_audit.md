...
- audit_ts: `2026-05-30T14:25:24Z`
- current top_n budget: `12000`
- high-value papers considered: `12,514`
- next delta queue needing primary section/action: `6,219`
...
| retry_class | count |
|---|---:|
| not_attempted_pdf_available | 6,153 |
| no_target_sections | 4,075 |
| covered | 2,240 |
...
| branch_split_driver | 1,970 | 1,970 | 653 | 653 | 1,970 |
